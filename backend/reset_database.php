...
$conn->query("DROP DATABASE IF EXISTS shebamiles_db");
$conn->query("CREATE DATABASE shebamiles_db");
...
$admin_sql = $conn->prepare("INSERT INTO users (email, password, first_name, last_name, role, status, is_verified) VALUES (?, ?, ?, ?, ?, ?, ?)");
$admin_sql->bind_param('ssssssi', $admin_email, $admin_password, $first_name, $last_name, $role, $status, $verified);
$first_name = 'Admin';
$last_name = 'User';
$role = 'admin';
$status = 'active';
